...
urlpatterns = [
	...
	url(r'^api/predictiveSemesters/', SemesterView.getPredictiveSemesters),
	...
	url(r'^api/activityStatisticByInfLocation/', ActivityView.getActivityStadisticByInfLocation),
	url(r'^api/activityStatisticBySupLocation/', ActivityView.getActivityStadisticBySupLocation),
    url(r'^api/activityMonitoringByLocation/', ActivityView.getActivityMonitoringByLocation),
	url(r'^api/deviceStatisticByInfLocation/', DeviceView.getDeviceStadisticByInfLocation),
	url(r'^api/deviceStatisticBySupLocation/', DeviceView.getDeviceStadisticBySupLocation),
    url(r'^api/deviceMonitoringByLocation/', DeviceView.getDeviceMonitoringByLocation),
	url(r'^api/deviceLifeTimeByLocation/', DeviceView.getDeviceLifeTimeByLocation),
